...
public class TextField extends Widget {
    ...
    /**
     * Returns the text field's style. Modifying the returned style may not have an effect until {@link #setStyle(com.badlogic.gdx.scenes.scene2d.ui.TextField.TextFieldStyle)}
     * is called.
     */
    ...
    private void calculateOffsets() {
        float visibleWidth = getWidth() - (textPaddingX * 2);
    ...
    public void draw(SpriteBatch batch, float parentAlpha) {
        ...
        if (focused && hasSelection && selection != null) {
            selection.draw(batch, x + selectionX + bgLeftWidth + renderOffset + textPaddingX, y + textY - textBounds.height - font.getDescent() - textPaddingY,
        ...
        if (displayText.length() == 0) {
            if (!focused && messageText != null) {
                ...
                messageFont.draw(batch, messageText, x + bgLeftWidth + textPaddingX, y + textY + yOffset - textPaddingY);
            }
        } else {
            font.setColor(fontColor.r, fontColor.g, fontColor.b, fontColor.a * parentAlpha);
            font.draw(batch, displayText, x + bgLeftWidth + textOffset + textPaddingX, y + textY + yOffset - textPaddingY, visibleTextStart, visibleTextEnd);
        }
        if (focused && !disabled) {
            blink();
            if (cursorOn && cursorPatch != null) {
                cursorPatch.draw(batch, x + bgLeftWidth + textOffset + glyphPositions.get(cursor)
                        - glyphPositions.items[visibleTextStart] - 1 + textPaddingX, y + textY - textBounds.height - font.getDescent() - textPaddingY,
    ...
    /**
     * Default is an instance of {@link com.badlogic.gdx.scenes.scene2d.ui.TextField.DefaultOnscreenKeyboard}.
     */
    ...
    /**
     * The default {@link com.badlogic.gdx.scenes.scene2d.ui.TextField.OnscreenKeyboard} used by all {@link com.badlogic.gdx.scenes.scene2d.ui.TextField} instances. Just uses
