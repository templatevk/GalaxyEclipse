...
public class GeStageUiFactory {
    ...
    public static IGeButtonBuilder createButtonBuilder() {
        return new GeDefaultButtonBuilder();
    }

    public static IGeTextFieldBuilder createTextFieldBuilder() {
        return new GeDefaultTextFieldBuilder();
    }
