...
public class GeBonusType {
    ...
    public boolean equals(Object o) {
        ...
        GeBonusType bonusType = (GeBonusType) o;
    ...
    private Set<GeBonus> bonuses;

    @OneToMany(mappedBy = "bonusType", fetch = FetchType.LAZY)
    public Set<GeBonus> getBonuses() {
        return bonuses;
    }

    public void setBonuses(Set<GeBonus> bonuses) {
