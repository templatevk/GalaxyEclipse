...
public class ShipTypes {
    ...
    @Column(name = "ship_type_armor_durability")
    @Basic
    ...
    @Column(name = "ship_type_energy_max")
    @Basic
    ...
    @Column(name = "ship_type_energy_regen")
    @Basic
    ...
    @Column(name = "ship_type_hp_regen")
    @Basic
    ...
    @Column(name = "ship_type_move_max_speed")
    @Basic
    ...
    @Column(name = "ship_type_move_acceleration")
    @Basic
    ...
    @Column(name = "ship_type_rotation_max_speed")
    @Basic
    ...
    @Column(name = "ship_type_rotation_acceleration")
    @Basic
    ...
    @Column(name = "weapon_slots_count")
    @Basic
